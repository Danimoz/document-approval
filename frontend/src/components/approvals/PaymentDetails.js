...
const PaymentDetails = ({ details}) => {
  ...
  return (
    <div className="my-3 ml-2 pl-2">
      ...
      <h5>{details.payment.title}</h5>
      <br />
      <h3 className="font-bold">MESSAGE</h3>
      <p className="whitespace-pre-line">{details.payment.message}</p>
      <br />
      <h3 className="font-bold">DOCUMENT</h3>
      <p className="whitespace-pre-line">{details.payment?.document}</p>
      <br />
      <h3 className="font-bold">STATUS</h3>
      <p className="whitespace-pre-line">{details.payment.state}</p>
      <br />
